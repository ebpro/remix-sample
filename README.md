...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create my-app-8ed5
  fly apps create my-app-8ed5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app my-app-8ed5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app my-app-8ed5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'my-app-8ed5-staging' does not match app name in config file 'my-app-8ed5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name my-app-8ed5-db
  fly postgres attach --app my-app-8ed5 my-app-8ed5-db

  fly postgres create --name my-app-8ed5-staging-db
  fly postgres attach --app my-app-8ed5-staging my-app-8ed5-staging-db
  ```
